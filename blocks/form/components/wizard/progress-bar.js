...
let wizardFooter;
let text;
const groupingSteps = (wizardEl) => {
    // Check how many step groups available
    const stepsGroup = wizardEl === null || wizardEl === void 0 ? void 0 : wizardEl.querySelectorAll(':scope > [data-stepgroup]');
...
export const createProgressBar = () => {
    ...
    const { step1GroupLength, step2GroupLength, step3GroupLength } = groupingSteps(wizard);
