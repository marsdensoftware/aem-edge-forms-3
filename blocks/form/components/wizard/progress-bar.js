...
const getGroupSteps = (root, group) => Array.from(root.querySelectorAll(`:scope > [data-stepgroup="${group}"]`));
const setBar = (el, widthPct, color) => {
...
const computeCurrentGroupProgress = (wizardEl, currentStepEl) => {
...
export const createProgressBar = () => {
    ...
    text = document.querySelector('.progress-bar__title');
};
export const trackProgress = () => {
    ...
    if (!showBar || !wizard || !currentWizard)
        return;
